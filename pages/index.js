  ...
  return (
    <Container mt={4}>
      ...
      >
        ...
        <br />
        Soy un ingeniero de sistemas que le apasiona los proyectos, la música y
        el baloncesto.
      </Box>
      ...
      <Box m={5} textAlign="center">
        <Link
          href="https://drive.google.com/file/d/1GwzknlX5yv9ztmhZ71vjN6DEHP13LW2-/view?usp=sharing"
          isExternal
        >
          <Button
        ...
        <NextLink href="/textMe">
          <Link m={2} fontWeight="bold">
            <Button border="1px solid">Trabaja conmigo</Button>
          </Link>
        </NextLink>
      </Box>
      ...
      >
        <PostWorkCard
          heading="Ibm Landing page"
          title="Ibm landing page"
          image="/images/works/ibm.png"
          link="https://ibm-landing-page-uvq1.vercel.app/"
        />
        <PostWorkCard
      ...
      <Heading mt={4} as="h2" fontSize="3xl">
        Social Media
      </Heading>
